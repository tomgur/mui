...
function Feed() {
  return (
    <Box flex={5} p={2} mt={1}>
      ...
      <Post author={"T"} avatarColor="red" title={"Deer in the snow!"} img={"static/images/deer.jpg"} text={"These deer were just running in the snow outside my house - Unbelievable!!!!"} favorite={true}/>
    </Box>
  );
}
export default Feed;